...
$(document).ready(function(){ $('#speak').click(function(){
$('#myaudio').stop(); $('#myaudio').attr('src','../Speaker?&' +
$('#myform').serialize()); $('#myaudio').attr('autoplay','autoplay');
}); });
</script>
</head>
<body>
	<form id="myform" method="post">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-10">
					<textarea rows="7" name="statement">
...
And she's buying a stairway to heaven
			...
			<div class="row">
				...
				<div class="col-lg-2 col-sm-2">
					<input type="button" id="speak" value="읽기" class=".btn-success"/><br />
